...
class WeekCalendar extends React.Component {
  ...
  updateWeekCalenderWhenEventAdded(){
    this.setState({selectedIntervals:this.props.selectedIntervals});
  }
  componentDidMount() {
    this.calculateColumnDimension();
    this.updateWeekCalenderWhenEventAdded();
      ...
      if (intervals.length > 0) {
        ...
        intervals.forEach((interval, index, array) => {
          ...
          const eventComponent = (
            ...
            >
              <EventComponent eventTitle={eventTitle} {...interval} />
            </div>
          );
