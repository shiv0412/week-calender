...
export class CalendarHeader extends React.Component {
  ...
  shouldComponentUpdate(nextProps) {
    ...
    || nextProps.columnDimensions !== this.props.columnDimensions ||  !nextProps.selectedIntervals.length !== this.props.selectedIntervals.length;
  }
    ...
    for (let i = 0; i < numberOfDays; i += 1) {
      ...
      const newCell = (
        <div key={i} className="weekCalendar__headerColumn" style={{ width }}>
          <HeaderCell  selectedIntervals={selectedIntervals} date={date} dayFormat={dayFormat}/>
        </div>
      );
